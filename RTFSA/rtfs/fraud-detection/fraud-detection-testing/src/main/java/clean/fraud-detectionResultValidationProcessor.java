 ...
 */
public class fraud-detectionResultValidationProcessor extends ContentResultValidationProcessor<fraud-detectionResult, fraud-detectionTestInput, fraud-detectionTestExpectation> {

    public fraud-detectionResultValidationProcessor(WorkerServices workerServices) {
        super(workerServices.getDataStore(), workerServices.getCodec(), fraud-detectionResult.class, fraud-detectionResultAccessors::getTextData, SettingsProvider.defaultProvider.getSetting(SettingNames.expectedFolder));
    }
     ...
     */
    @Override
    protected boolean processWorkerResult(TestItem<fraud-detectionTestInput, fraud-detectionTestExpectation> testItem, TaskMessage message, fraud-detectionResult workerResult) throws Exception {
