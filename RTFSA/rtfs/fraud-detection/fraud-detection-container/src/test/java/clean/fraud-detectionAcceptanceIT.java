...
/**
 * Integration test for fraud-detection, running the testing framework.
 */
public class fraud-detectionAcceptanceIT extends UseAsTestName_TestBase
{
    ...
    {
        testControllerProvider = new fraud-detectionTestControllerProvider();
