...
/**
 * Configuration for the fraud-detection, read in from src/main/config/cfg~caf~worker~fraud-detectionConfiguration.
 */
public class fraud-detectionConfiguration extends WorkerConfiguration {
    ...
    public fraud-detectionConfiguration() { }
