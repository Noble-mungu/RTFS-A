 ...
 * the action to take.
 */
public final class fraud-detectionTask {
     ...
     * Example usage is located in fraud-detection class, 'wrapAsReferencedData' method.
     */
     ...
     */
    public fraud-detectionAction action;
}
