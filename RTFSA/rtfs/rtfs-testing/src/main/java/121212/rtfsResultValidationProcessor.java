 ...
 */
public class rtfsResultValidationProcessor extends ContentResultValidationProcessor<rtfsResult, rtfsTestInput, rtfsTestExpectation> {

    public rtfsResultValidationProcessor(WorkerServices workerServices) {
        super(workerServices.getDataStore(), workerServices.getCodec(), rtfsResult.class, rtfsResultAccessors::getTextData, SettingsProvider.defaultProvider.getSetting(SettingNames.expectedFolder));
    }
     ...
     */
    @Override
    protected boolean processWorkerResult(TestItem<rtfsTestInput, rtfsTestExpectation> testItem, TaskMessage message, rtfsResult workerResult) throws Exception {
