...
/**
 * Health check for the rtfs, health is displayed on the Marathon GUI.
 */
public class rtfsHealthCheck implements HealthReporter {

    //for logging.
    private static final Logger LOG = LoggerFactory.getLogger(rtfs.class);

    public rtfsHealthCheck() {
    }
    ...
    public HealthResult healthCheck() {
        ...
        // In this scenario, the rtfs does not depend on any external components. It will always return HealthResult.RESULT_HEALTHY.
