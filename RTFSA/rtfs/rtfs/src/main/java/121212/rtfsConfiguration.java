...
/**
 * Configuration for the rtfs, read in from src/main/config/cfg~caf~worker~rtfsConfiguration.
 */
public class rtfsConfiguration extends WorkerConfiguration {
