...
/**
 * Integration test for rtfs, running the testing framework.
 */
public class rtfsAcceptanceIT extends UseAsTestName_TestBase
{
    ...
    {
        testControllerProvider = new rtfsTestControllerProvider();
