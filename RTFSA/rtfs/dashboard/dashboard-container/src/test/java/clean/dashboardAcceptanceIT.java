...
/**
 * Integration test for dashboard, running the testing framework.
 */
public class dashboardAcceptanceIT extends UseAsTestName_TestBase
{
    ...
    {
        testControllerProvider = new dashboardTestControllerProvider();
