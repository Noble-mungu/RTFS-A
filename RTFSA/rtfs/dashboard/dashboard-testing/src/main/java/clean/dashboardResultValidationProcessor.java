 ...
 */
public class dashboardResultValidationProcessor extends ContentResultValidationProcessor<dashboardResult, dashboardTestInput, dashboardTestExpectation> {

    public dashboardResultValidationProcessor(WorkerServices workerServices) {
        super(workerServices.getDataStore(), workerServices.getCodec(), dashboardResult.class, dashboardResultAccessors::getTextData, SettingsProvider.defaultProvider.getSetting(SettingNames.expectedFolder));
    }
     ...
     */
    @Override
    protected boolean processWorkerResult(TestItem<dashboardTestInput, dashboardTestExpectation> testItem, TaskMessage message, dashboardResult workerResult) throws Exception {
