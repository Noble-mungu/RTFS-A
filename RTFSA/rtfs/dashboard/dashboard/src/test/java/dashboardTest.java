...
import clean.dashboardAction;
import clean.dashboardResult;
import clean.dashboardTask;
...
public class dashboardTest {
     ...
     */
    @Test
    public void testdashboardReverse() throws Exception {
        //Codec
        ...
        dashboard worker = new dashboard(createMockTask(dashboardAction.REVERSE), mockDataStore, "mockQueue", codec, 1024,
        ...
        dashboardResult workerResult = codec.deserialise(response.getData(), dashboardResult.class);
     ...
     */
    @Test
    public void testdashboardCapitalise() throws Exception {
        //Codec
        Codec codec = new JsonCodec();
        ...
        //Create the worker subject to testing
        dashboard worker = new dashboard(createMockTask(dashboardAction.CAPITALISE), mockDataStore, "mockQueue", codec, 1024,
                                                 Mockito.mock(WorkerTaskData.class));
     ...
     * @throws IOException
     */
    private dashboardTask createMockTask(dashboardAction action) throws IOException {
