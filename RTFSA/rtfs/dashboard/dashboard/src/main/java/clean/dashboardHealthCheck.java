...
/**
 * Health check for the dashboard, health is displayed on the Marathon GUI.
 */
public class dashboardHealthCheck implements HealthReporter {
    ...
    public HealthResult healthCheck() {
        ...
        // In this scenario, the dashboard does not depend on any external components. It will always return HealthResult.RESULT_HEALTHY.
