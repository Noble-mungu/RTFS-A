...
/**
 * Configuration for the dashboard, read in from src/main/config/cfg~caf~worker~dashboardConfiguration.
 */
public class dashboardConfiguration extends WorkerConfiguration {
