...
/**
 * Integration test for creditcardproducer, running the testing framework.
 */
public class creditcardproducerAcceptanceIT extends UseAsTestName_TestBase
{
    ...
    {
        testControllerProvider = new creditcardproducerTestControllerProvider();
