...
import creditcardproducer.creditcardproducer;
import creditcardproducer.creditcardproducerAction;
import creditcardproducer.creditcardproducerResult;
import creditcardproducer.creditcardproducerTask;
 ...
 */
public class creditcardproducerTest {
     ...
     */
    @Test
    public void testcreditcardproducerReverse() throws Exception {
        //Codec
        ...
        creditcardproducer worker = new creditcardproducer(createMockTask(creditcardproducerAction.REVERSE), mockDataStore, "mockQueue", codec, 1024,
        ...
        creditcardproducerResult workerResult = codec.deserialise(response.getData(), creditcardproducerResult.class);
     ...
     */
    @Test
    public void testcreditcardproducerCapitalise() throws Exception {
        //Codec
        Codec codec = new JsonCodec();
        ...
        //Create the worker subject to testing
        creditcardproducer worker = new creditcardproducer(createMockTask(creditcardproducerAction.CAPITALISE), mockDataStore, "mockQueue", codec, 1024,
                                                 Mockito.mock(WorkerTaskData.class));
     ...
     * @param action
     * @return creditcardproducerTask
     * @throws IOException
     */
    private creditcardproducerTask createMockTask(creditcardproducerAction action) throws IOException {
        String text = "Secretary of state";
        ReferencedData mockReferencedData = ReferencedData.getWrappedData(text.getBytes());
        creditcardproducerTask task = new creditcardproducerTask();
