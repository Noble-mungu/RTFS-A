...
/**
 * Health check for the creditcardproducer, health is displayed on the Marathon GUI.
 */
public class creditcardproducerHealthCheck implements HealthReporter {

    //for logging.
    private static final Logger LOG = LoggerFactory.getLogger(creditcardproducer.class);

    public creditcardproducerHealthCheck() {
    }
    ...
    public HealthResult healthCheck() {
        ...
        // In this scenario, the creditcardproducer does not depend on any external components. It will always return HealthResult.RESULT_HEALTHY.
