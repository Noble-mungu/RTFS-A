...
/**
 * Configuration for the creditcardproducer, read in from src/main/config/cfg~caf~worker~creditcardproducerConfiguration.
 */
public class creditcardproducerConfiguration extends WorkerConfiguration {
    ...
    public creditcardproducerConfiguration() { }
