 ...
 * the action to take.
 */
public final class creditcardproducerTask {
     ...
     * Example usage is located in creditcardproducer class, 'wrapAsReferencedData' method.
     */
     ...
     */
    public creditcardproducerAction action;
}
